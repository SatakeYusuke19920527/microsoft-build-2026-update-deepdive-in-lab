...
| [03](./03-sdk-cli-runtime/README.md) | **SDK / CLI / 実行基盤** | Copilot SDK GA（6言語）・新 Terminal UI・Voice Input・Prompt Scheduling・Rubber Duck 連携 |
| [04](./04-cloud-agent-context-ecosystem/README.md) | **Cloud Agent / 継続コンテキスト / エコシステム** | Cloud Automations/Autopilot・業務範囲拡張・Memory++/`/chronicle`・Partner Apps・Gemini・MAI-Code-1-Flash |
...
- Microsoft: [microsoft/Build26-news](https://github.com/microsoft/Build26-news)
