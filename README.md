...
3. Microsoft の **MAI-Code-1** が Copilot / VS Code に搭載され、**Microsoft IQ** がエージェントに世界知識と業務知識を接続。さらに **Build in GitHub → Run in Foundry → Govern with Agent 365** という enterprise 像が示された。
